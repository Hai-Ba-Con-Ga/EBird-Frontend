...
import useBirdAdmin from '../../components/admin/bird/useBirdAdmin'
...
const BirdPage = () => {
    ...
    const {birds,tablePagination,selected,isAllSelected,onDeselectAll,rowSelected,onSelectAll}= useBirdAdmin();
