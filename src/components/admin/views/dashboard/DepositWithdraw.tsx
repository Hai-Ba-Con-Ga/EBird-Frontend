        ...
        <CardContent sx={{ pb: theme => `${theme.spacing(5.5)} !important` }}>
          {depositData.map((item: DataType, index: number) => {
            return (
              ...
              >
                <Box  component={'div'} sx={{ minWidth: 38, display: 'flex', justifyContent: 'center' }}>
                ...
                <Box
                  ...
                  component={'div'} 
                >
                  <Box  component={'div'} sx={{ marginRight: 2, display: 'flex', flexDirection: 'column' }}>
          ...
          {withdrawData.map((item: DataType, index: number) => {
            return (
              ...
              component={'div'}
                ...
                sx={{ display: 'flex', alignItems: 'center', mb: index !== depositData.length - 1 ? 6 : 0 }}
              >
                <Box  component={'div'} sx={{ minWidth: 36, display: 'flex', justifyContent: 'center' }}>
                  <img src={item.logo} alt={item.title} width={item.logoWidth} height={item.logoHeight} />
                </Box>
                <Box
                 component={'div'}
